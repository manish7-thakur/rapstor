...
{
if(shortDescField.getText().equals("")) {JOptionPane.showMessageDialog(null,"Short Description should not be empty.");return;}
if(longDescArea.getText().equals("")) {JOptionPane.showMessageDialog(null,"Long Description should not be empty."); return;}
if((String) messTypeBox.getSelectedItem() == "Select") {JOptionPane.showMessageDialog(null,"Please select the message type."); return;}
